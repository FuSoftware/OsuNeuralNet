...
namespace OsuNeuralNet
{
    class TaikoNetwork
    {
        ...
        int Outputs = 4;
        int Inputs = 1000 * 3;
        //string[] outputs = new string[4] { "S", "D", "L", "M" };

        PopulationPool pool = new PopulationPool();

        private struct PopulationPool
        {
            public int innovation;
            public List<PopulationSpecies> species;
            public int generation;
            public int innocation;
        ...
        private struct PopulationSpecies
        {
            public int topFitness;
            public int staleness;
            public List<PopulationGenome> genomes;
            public int averageFitness;
        }

        private struct PopulationGenome
        {
            public List<PopulationGene> genes;
            public int fitness ;
            public int adjustedFitness ;
            public PopulationNetwork network;
            public int maxneuron ;
            public int globalRank ;
            public Dictionary<string, double> mutationRates;
        }

        public struct PopulationGene
        {
            public int into;
            public int outVal;
        ...
        public struct PopulationNeuron
        {
            public List<double> incoming;
            public double value;
        }

        public struct PopulationNetwork
        {
            public List<PopulationNeuron> neurons;
        }
        ...
        private PopulationPool newPool()
        {
            PopulationPool pool = new PopulationPool();
            pool.species = new List<PopulationSpecies>();
            pool.generation = 0;
        ...
        private PopulationSpecies newSpecies()
        {
            PopulationSpecies species = new PopulationSpecies();
            species.topFitness = 0;
            species.staleness = 0;

            species.genomes = new List<PopulationGenome>();
        ...
        private PopulationGene newGene()
        {
            PopulationGene gene = new PopulationGene();
            gene.into = 0;
            gene.outVal = 0;
            gene.weight = 0.0;
            gene.enabled = true;
        ...
        private PopulationNeuron newNeuron()
        {
            PopulationNeuron neuron = new PopulationNeuron();
            neuron.incoming = new List<double>();
            neuron.value = 0.0;
